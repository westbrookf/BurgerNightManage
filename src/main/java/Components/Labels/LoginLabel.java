...
public class LoginLabel {
	...
	public static Label userLoginLabel() {
		// Creation of the Craate account label, THIS WILL SIT IN THE LABEL COMPONENTS
		// FOLDER WITH OTHER TITLE COMPONENTS
		Label instructText = new Label();
		instructText.setText("Login");
